  ...
  <Card className="bg-white dark:bg-card border-border hover:shadow-md transition-all h-full flex flex-col">
    <CardContent className="pt-6 px-6 flex-1 flex flex-col">
      <div className="mb-4 text-brand-500">
        ...
        >
          <path
            d="M9.59 4.59A2 2 0 1 1 11 8H9.5C9.5 9.5 10 13 13 15.5V16c-1 1-2.5 1.5-4 1.5-4 0-5-3.5-5-5.5C4 10 5 7 9.59 4.59zM21 15.5V16c-1 1-2.5 1.5-4 1.5-4 0-5-3.5-5-5.5 0-2 1-5 5.59-7.41A2 2 0 1 1 19 8h-1.5c0 1.5.5 5 3.5 7.5z"
            fill="currentColor"
          />
        </svg>
      </div>
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-12">
            ...
            >
              ...
              <p className="text-lg md:text-xl text-muted-foreground mb-8 max-w-2xl">
                FeedSync helps you collect meaningful feedback from users,
                analyze trends, and make data-driven improvements to your
                products.
              </p>
              {isAuthenticated ? (
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
              Everything you need to collect and analyze feedback, all in one
              platform.
            </p>
          </div>
      ...
      <section className="py-16 md:py-24">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
              Join thousands of companies that use FeedSync to improve their
          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            >
              ...
              <p className="text-lg text-muted-foreground mb-8 max-w-3xl mx-auto">
                Join thousands of companies using FeedSync to collect meaningful
